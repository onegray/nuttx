/************************************************************************************
 * arch/arm/include/stm32wb/stm32wb55xx_irq.h
 *
 ...
 * nuttx/arch/arm/include/stm32wb/irq.h which includes this file
 *
...
#define STM32WB_IRQ_PVD         (STM32WB_IRQ_FIRST + 1)  /* 1:  PVD through EXTI Line detection interrupt */
#define STM32WB_IRQ_TAMPER      (STM32WB_IRQ_FIRST + 2)  /* 2:  Tamper and time stamp interrupts */
#define STM32WB_IRQ_TIMESTAMP   (STM32WB_IRQ_FIRST + 2)  /* 2:  Tamper and time stamp interrupts */
...
#define STM32WB_IRQ_CRS         (STM32WB_IRQ_FIRST + 42) /* 42: CRS global interrupt */
