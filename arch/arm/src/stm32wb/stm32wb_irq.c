...
static int stm32wb_nmi(int irq, FAR void *context, FAR void *arg)
{
  up_irq_save();
...
static int stm32wb_busfault(int irq, FAR void *context, FAR void *arg)
{
  up_irq_save();
...
static int stm32wb_usagefault(int irq, FAR void *context, FAR void *arg)
{
  up_irq_save();
...
static int stm32wb_pendsv(int irq, FAR void *context, FAR void *arg)
{
  up_irq_save();
...
static int stm32wb_dbgmonitor(int irq, FAR void *context, FAR void *arg)
{
  up_irq_save();
...
static int stm32wb_reserved(int irq, FAR void *context, FAR void *arg)
{
  up_irq_save();
