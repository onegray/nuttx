...
#if defined(CONFIG_USART1_SERIAL_CONSOLE) && defined(CONFIG_STM32WB_USART1_SERIALDRIVER)
...
/* Disable the DMA configuration on unused USART */
...
/* Is DMA used on enabled USART */

#define SERIAL_HAVE_ONLY_DMA 1
#if defined(CONFIG_STM32WB_USART1_SERIALDRIVER) && !defined(CONFIG_USART1_RXDMA)
