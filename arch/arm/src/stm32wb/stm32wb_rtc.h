...
#define STM32WB_RTC_PRESCALER_SECOND        32767  /* Default prescaler to get a second base */
#define STM32WB_RTC_PRESCALER_MIN           1      /* Maximum speed of 16384 Hz */
...
int stm32wb_rtc_getdatetime_with_subseconds(FAR struct tm *tp, FAR long *nsec);
#endif
...
struct tm;
int stm32wb_rtc_setdatetime(FAR const struct tm *tp);
#endif
...
int stm32wb_rtc_setalarm(FAR struct alm_setalarm_s *alminfo);
...
int stm32wb_rtc_rdalarm(FAR struct alm_rdalarm_s *alminfo);
...
int stm32wb_rtc_setperiodic(FAR const struct timespec *period, wakeupcb_t callback);
...
FAR struct rtc_lowerhalf_s *stm32wb_rtc_lowerhalf(void);
#endif
