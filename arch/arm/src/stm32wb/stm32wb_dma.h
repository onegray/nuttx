 ...
 *   arg    - A user-provided value that was provided when stm32wb_dmastart() was
 *            called.
 */
 ...
 *   in a call to stm32wb_dmachannel, then this function will re-assign the
 *   DMA channel to that thread and wake it up.  NOTE:  The 'handle' used
 *   in this argument must NEVER be used again until stm32wb_dmachannel() is
 ...
 *   reset and stm32wb_dmasetup() must be called before stm32wb_dmastart() can be
 *   called again
 *
 * Assumptions:
 *   - DMA handle allocated by stm32wb_dmachannel()
