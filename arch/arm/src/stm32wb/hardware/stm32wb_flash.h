...
#define STM32WB_FLASH_ACR               (STM32WB_FLASH_BASE + STM32WB_FLASH_ACR_OFFSET)
#define STM32WB_FLASH_KEYR              (STM32WB_FLASH_BASE + STM32WB_FLASH_KEYR_OFFSET)
#define STM32WB_FLASH_OPTKEYR           (STM32WB_FLASH_BASE + STM32WB_FLASH_OPTKEYR_OFFSET)
#define STM32WB_FLASH_SR                (STM32WB_FLASH_BASE + STM32WB_FLASH_SR_OFFSET)
#define STM32WB_FLASH_CR                (STM32WB_FLASH_BASE + STM32WB_FLASH_CR_OFFSET)
#define STM32WB_FLASH_ECCR              (STM32WB_FLASH_BASE + STM32WB_FLASH_ECCR_OFFSET)
#define STM32WB_FLASH_OPTR              (STM32WB_FLASH_BASE + STM32WB_FLASH_OPTR_OFFSET)
#define STM32WB_FLASH_PCROP1ASR         (STM32WB_FLASH_BASE + STM32WB_FLASH_PCROP1ASR_OFFSET)
#define STM32WB_FLASH_PCROP1AER         (STM32WB_FLASH_BASE + STM32WB_FLASH_PCROP1AER_OFFSET)
#define STM32WB_FLASH_WRP1AR            (STM32WB_FLASH_BASE + STM32WB_FLASH_WRP1AR_OFFSET)
#define STM32WB_FLASH_WRP1BR            (STM32WB_FLASH_BASE + STM32WB_FLASH_WRP1BR_OFFSET)
#define STM32WB_FLASH_PCROP1BSR         (STM32WB_FLASH_BASE + STM32WB_FLASH_PCROP1BSR_OFFSET)
#define STM32WB_FLASH_PCROP1BER         (STM32WB_FLASH_BASE + STM32WB_FLASH_PCROP1BER_OFFSET)
#define STM32WB_FLASH_IPCCBR            (STM32WB_FLASH_BASE + STM32WB_FLASH_IPCCBR_OFFSET)
#define STM32WB_FLASH_C2ACR             (STM32WB_FLASH_BASE + STM32WB_FLASH_C2ACR_OFFSET)
#define STM32WB_FLASH_C2SR              (STM32WB_FLASH_BASE + STM32WB_FLASH_C2SR_OFFSET)
#define STM32WB_FLASH_C2CR              (STM32WB_FLASH_BASE + STM32WB_FLASH_C2CR_OFFSET)
#define STM32WB_FLASH_SFR               (STM32WB_FLASH_BASE + STM32WB_FLASH_SFR_OFFSET)
#define STM32WB_FLASH_SRRVR             (STM32WB_FLASH_BASE + STM32WB_FLASH_SRRVR_OFFSET)
