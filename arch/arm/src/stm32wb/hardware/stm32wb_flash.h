 ...
 *   CONFIG_STM32WB_FLASH_CONFIG_x selects the default FLASH size based on the chip
 *   part number. This value can be overridden with CONFIG_STM32WB_FLASH_OVERRIDE_x
 *
...
#define STM32WB_FLASH_ACR_OFFSET        0x0000  /* Flash memory access control register */
#define STM32WB_FLASH_KEYR_OFFSET       0x0008  /* Flash memory key register */
#define STM32WB_FLASH_OPTKEYR_OFFSET    0x000c  /* Flash memory option key register */
#define STM32WB_FLASH_SR_OFFSET         0x0010  /* Flash memory status register */
#define STM32WB_FLASH_CR_OFFSET         0x0014  /* Flash memory control register */
#define STM32WB_FLASH_ECCR_OFFSET       0x0018  /* Flash memory ECC register */
#define STM32WB_FLASH_OPTR_OFFSET       0x0020  /* Flash memory option register */
#define STM32WB_FLASH_PCROP1ASR_OFFSET  0x0024  /* Flash memory PCROP zone A start address register */
#define STM32WB_FLASH_PCROP1AER_OFFSET  0x0028  /* Flash memory PCROP zone A end address register */
#define STM32WB_FLASH_WRP1AR_OFFSET     0x002c  /* Flash memory WRP area A address register */
#define STM32WB_FLASH_WRP1BR_OFFSET     0x0030  /* Flash memory WRP area B address register */
#define STM32WB_FLASH_PCROP1BSR_OFFSET  0x0034  /* Flash memory PCROP zone B start address register */
#define STM32WB_FLASH_PCROP1BER_OFFSET  0x0038  /* Flash memory PCROP zone B end address register */
#define STM32WB_FLASH_IPCCBR_OFFSET     0x003C  /* Flash memory IPCC mailbox data buffer address register */
#define STM32WB_FLASH_C2ACR_OFFSET      0x005C  /* CPU2 Flash memory access control register */
#define STM32WB_FLASH_C2SR_OFFSET       0x0060  /* CPU2 Flash memory status register */
#define STM32WB_FLASH_C2CR_OFFSET       0x0064  /* CPU2 Flash memory control register */
#define STM32WB_FLASH_SFR_OFFSET        0x0080  /* Secure Flash memory start address register */
#define STM32WB_FLASH_SRRVR_OFFSET      0x0084  /* Secure SRAM2 start address and CPU2 reset vector register */

/* Register Addresses *******************************************************/

#define STM32WB_FLASH_ACR               (STM32WB_FLASHIF_BASE + STM32WB_FLASH_ACR_OFFSET)
#define STM32WB_FLASH_KEYR              (STM32WB_FLASHIF_BASE + STM32WB_FLASH_KEYR_OFFSET)
#define STM32WB_FLASH_OPTKEYR           (STM32WB_FLASHIF_BASE + STM32WB_FLASH_OPTKEYR_OFFSET)
#define STM32WB_FLASH_SR                (STM32WB_FLASHIF_BASE + STM32WB_FLASH_SR_OFFSET)
#define STM32WB_FLASH_CR                (STM32WB_FLASHIF_BASE + STM32WB_FLASH_CR_OFFSET)
#define STM32WB_FLASH_ECCR              (STM32WB_FLASHIF_BASE + STM32WB_FLASH_ECCR_OFFSET)
#define STM32WB_FLASH_OPTR              (STM32WB_FLASHIF_BASE + STM32WB_FLASH_OPTR_OFFSET)
#define STM32WB_FLASH_PCROP1ASR         (STM32WB_FLASHIF_BASE + STM32WB_FLASH_PCROP1ASR_OFFSET)
#define STM32WB_FLASH_PCROP1AER         (STM32WB_FLASHIF_BASE + STM32WB_FLASH_PCROP1AER_OFFSET)
#define STM32WB_FLASH_WRP1AR            (STM32WB_FLASHIF_BASE + STM32WB_FLASH_WRP1AR_OFFSET)
#define STM32WB_FLASH_WRP1BR            (STM32WB_FLASHIF_BASE + STM32WB_FLASH_WRP1BR_OFFSET)
#define STM32WB_FLASH_PCROP1BSR         (STM32WB_FLASHIF_BASE + STM32WB_FLASH_PCROP1BSR_OFFSET)
#define STM32WB_FLASH_PCROP1BER         (STM32WB_FLASHIF_BASE + STM32WB_FLASH_PCROP1BER_OFFSET)
#define STM32WB_FLASH_IPCCBR            (STM32WB_FLASHIF_BASE + STM32WB_FLASH_IPCCBR_OFFSET)
#define STM32WB_FLASH_C2ACR             (STM32WB_FLASHIF_BASE + STM32WB_FLASH_C2ACR_OFFSET)
#define STM32WB_FLASH_C2SR              (STM32WB_FLASHIF_BASE + STM32WB_FLASH_C2SR_OFFSET)
#define STM32WB_FLASH_C2CR              (STM32WB_FLASHIF_BASE + STM32WB_FLASH_C2CR_OFFSET)
#define STM32WB_FLASH_SFR               (STM32WB_FLASHIF_BASE + STM32WB_FLASH_SFR_OFFSET)
#define STM32WB_FLASH_SRRVR             (STM32WB_FLASHIF_BASE + STM32WB_FLASH_SRRVR_OFFSET)

/* Register Bitfield Definitions ********************************************/

/* Flash memory access control register (ACR) */
...
/* Flash memory status register (SR) */
...
/* Flash memory control register (CR) */
...
/* Flash memory ECC register (ECCR) */
...
/* Flash memory option register (OPTR) */

#define FLASH_OPTR_RDP_SHIFT       (0)        /* Bits 0-7: Read protection level  */
#define FLASH_OPTR_RDP_MASK        (0xff << FLASH_ECCR_RDP_SHIFT)
#  define FLASH_OPTR_RDPLEV0       (0xaa << FLASH_ECCR_RDP_SHIFT) /* 0xAA: Level 0, read protection not active */
#  define FLASH_OPTR_RDPLEV2       (0xcc << FLASH_ECCR_RDP_SHIFT) /* 0xCC: Level 2, chip read protection active */
#  define FLASH_OPTR_RDPLEV1       (0x01 << FLASH_ECCR_RDP_SHIFT) /* Others: Level 1, memories read protection active */
...
/* Flash memory PCROP zone B end address register (PCROP1BER) */
...
/* Flash memory IPCC mailbox data buffer address register (IPCCBR) */
...
/* CPU2 Flash memory access control register (C2ACR) */
...
/* CPU2 Flash memory status register (C2SR) */
...
/* CPU2 Flash memory control register (C2CR) */
...
#define FLASH_C2CR_PNB_MASK         (0xff << FLASH_CR_PNB_SHIFT)
#  define FLASH_CR_PNB(n)           ((n)  << FLASH_CR_PNB_SHIFT) /* Page n, n = 0..255 */
...
/* Secure Flash memory start address register (SFR) */

#define FLASH_SFR_SFSA_SHIFT        (0)       /* Bits 0-7: Secure flash memory start address */
#define FLASH_SFR_SFSA_MASK         (0xff << FLASH_SFR_SFSA_SHIFT)
#define FLASH_SFR_FSD               (1 << 8)  /* Bit 8: Flash memory security disabled */
#define FLASH_SFR_DDS               (1 << 12) /* Bit 12: Disable CPU2 debug access */

/* Flash memory secure SRAM2 start address and CPU2 reset vector register (SRRVR) */
