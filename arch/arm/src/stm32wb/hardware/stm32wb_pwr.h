...
#define STM32L4_PWR_CR5_OFFSET    0x001C  /* Power control register 5 */
...
#define STM32L4_PWR_C2CR1_OFFSET  0x0080  /* CPU2 control register 1 */
#define STM32L4_PWR_C2CR3_OFFSET  0x0084  /* CPU2 control register 3 */
#define STM32L4_PWR_EXTSCR_OFFSET 0x0088  /* Extended status and status clear register */
...
#define STM32L4_PWR_C2CR1         (STM32L4_PWR_BASE + STM32L4_PWR_C2CR1_OFFSET)
#define STM32L4_PWR_C2CR3         (STM32L4_PWR_BASE + STM32L4_PWR_C2CR3_OFFSET)
#define STM32L4_PWR_EXTSCR        (STM32L4_PWR_BASE + STM32L4_PWR_EXTSCR_OFFSET)
...
#  define PWR_SR2_PVMO1_ABV      (0 << 12) /* 0: VDDUSB voltage is above PVM1 threshold (~ 1.2 V) */
#  define PWR_SR2_PVMO1_BLW      (1 << 12) /* 1: VDDUSB voltage is below PVM1 threshold (~ 1.2 V) */
#define PWR_SR2_PVMO3            (1 << 14) /* Bit 14: VDDA voltage monitoring output (VDDA vs PVM3) */
#  define PWR_SR2_PVMO3_ABV      (0 << 14) /* 0: VDDA voltage is above PVM3 threshold (~ 1.62 V) */
#  define PWR_SR2_PVMO3_BLW      (1 << 14) /* 1: VDDA voltage is below PVM3 threshold (~ 1.62 V) */
