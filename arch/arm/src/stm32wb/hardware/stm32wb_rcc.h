...
#define RCC_PLLCFG_PLLSRC_SHIFT     (0)       /* Bit 0-1: Main PLL and audio PLLSAI1 entry clock source */
...
#define RCC_PLLCFG_PLLQ_MASK        (0x3 << RCC_PLLCFG_PLLQ_SHIFT)
...
#define RCC_PLLCFG_PLLR_MASK        (0x3 << RCC_PLLCFG_PLLR_SHIFT)
...
#  define RCC_HSECR_HSES_12         (0)       /* 0: HSE bias current factor 1/2 */
#  define RCC_HSECR_HSES_34         (1)       /* 1: HSE bias current factor 3/4 */
...
#define RCC_EXTCFGR_C2HPRE_SHIFT    (0)       /* Bits: 4-7: CPU2 HCLK2 prescaler */
...
#  define RCC_HSECR_RFCSS_HSI16     (0)        /* HSI16 used for Radio system HCLK5 and APB3 clock */
#  define RCC_HSECR_RFCSS_HSE2      (1)        /* HSE divided by 2 used for Radio system HCLK5 and APB3 clock */
