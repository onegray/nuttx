...
void arm_lowputc(char ch)
{
  ...
  while ((getreg32(STM32WB_CONSOLE_BASE + STM32WB_USART_ISR_OFFSET) & USART_ISR_TXE) == 0);
#ifdef STM32WB_CONSOLE_RS485_DIR
  stm32wb_gpiowrite(STM32WB_CONSOLE_RS485_DIR, STM32WB_CONSOLE_RS485_DIR_POLARITY);
#endif
...
#ifdef STM32WB_CONSOLE_RS485_DIR
  while ((getreg32(STM32WB_CONSOLE_BASE + STM32WB_USART_ISR_OFFSET) & USART_ISR_TC) == 0);
  stm32wb_gpiowrite(STM32WB_CONSOLE_RS485_DIR, !STM32WB_CONSOLE_RS485_DIR_POLARITY);
#endif
...
void stm32wb_lowsetup(void)
{
   ...
   *
   * NOTE: Clocking for selected U[S]ARTs was already provided in stm32wb_rcc.c
   */
  ...
  putreg32(STM32WB_BRR_VALUE, STM32WB_CONSOLE_BASE + STM32WB_USART_BRR_OFFSET);
