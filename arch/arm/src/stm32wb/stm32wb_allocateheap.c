 ...
 * SRAM2A_END
 * SRAM2A_START  0x20038000
 * SRAM2A_END
 */

/* STM32WB35xx have 96 Kib:
 *
 *   1) 32 KiB of System SRAM1 beginning at address 0x2000:0000 - 0x2000:8000
 *   2) 32 KiB of System SRAM2a beginning at address 0x2003:0000 - 0x2003:8000
 *   3) 32 KiB of System SRAM2b beginning at address 0x2003:8000 - 0x2004:0000
 *
 * STM32WB55xC have 128 Kib:
 *
 *   1) 64 KiB of System SRAM1 beginning at address 0x2000:0000 - 0x2001:0000
 *   2) 32 KiB of System SRAM2a beginning at address 0x2003:0000 - 0x2003:8000
 *   3) 32 KiB of System SRAM2b beginning at address 0x2003:8000 - 0x2004:0000
 *
 * STM32WB55x[E,Y,G] have 256 Kib:
 *
 *   1) 192 KiB of System SRAM1 beginning at address 0x2000:0000 - 0x2001:8000
 *   2) 32 KiB of System SRAM2a beginning at address 0x2003:0000 - 0x2003:8000
 *   3) 32 KiB of System SRAM2b beginning at address 0x2003:8000 - 0x2004:0000
 */
...
#define SRAM2A_START  STM32WB_SRAM2A_BASE
#define SRAM2A_END    (SRAM2A_START + STM32WB_SRAM2A_SIZE)

/* Set the range of SRAM2b as well, requires a third memory region */

#define SRAM2B_START  STM32WB_SRAM2B_BASE
#define SRAM2B_END    (SRAM2B_START + STM32WB_SRAM2B_SIZE)
...
void arm_addregion(void)
{
  ...
  up_heap_color((FAR void *)SRAM2A_START, SRAM2A_END-SRAM2A_START);

  /* Add the SRAM2A user heap region. */

  kumm_addregion((FAR void *)SRAM2A_START, SRAM2A_END-SRAM2A_START);
  ...
  up_heap_color((FAR void *)SRAM2B_START, SRAM2B_END-SRAM2B_START);

  /* Add the SRAM2b user heap region. */

  kumm_addregion((FAR void *)SRAM2B_START, SRAM2B_END-SRAM2B_START);
